...
import { getMedicalRecordsById } from '../../../services/ApiService';
  ...
  useEffect(() => {
    const fetchMedicalRecords = async () => {
      if (user?.employeeObj.employeeId) {
        try {
          const data = await getMedicalRecordsById(user.employeeObj.employeeId);
      ...
      <div className="container mx-auto py-8">
        ...
        <div className="overflow-x-auto">
          {medicalRecords.length === 0 ? (
            <div className="text-center py-4 text-xl font-semibold text-gray-700 dark:text-gray-300">
