      ...
      <div className="lg:w-1/2 xl:w-1/2 bg-gray-100">
        <div className="p-8 mt-12 md:w-3/4 mx-auto lg:px-0 xl:p-8 w-full">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button className="w-full cursor-pointer mt-2.5 bg-primary hover:bg-primary-hover text-white font-bold py-4 rounded-lg transition duration-300 ease-in-out">
              Create account
            </button>
          </form>
