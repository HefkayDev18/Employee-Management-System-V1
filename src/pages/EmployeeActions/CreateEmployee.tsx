    ...
    return (
        <>
            ...
            <div className="container py-8 px-6 bg-gray-900 rounded-lg shadow-lg">
                <h1 className="text-3xl font-bold text-center mb-8 dark:text-white">Create A New Employee</h1>
                <form onSubmit={handleSubmit} className="max-w-full">
                    ...
                    <div className="flex justify-center mt-6">
                        <button type="submit" className="bg-primary text-white py-3 px-6 rounded-lg font-medium transition hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-primary-dark">Create Employee</button>
                    </div>
                </form>
            </div>
        </>
